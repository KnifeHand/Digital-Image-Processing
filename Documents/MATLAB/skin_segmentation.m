...
%folder = fullfile(matlabroot, '.\standart_test_images\');
%baseFileName = imread('.\standart_test_images\face_dark.bmp');
...
[indexedImage, colorMap] = imread('./standard_test_images/face_dark');
