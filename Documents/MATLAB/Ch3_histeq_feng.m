...
close all
clc
im=imread('./standard_test_images/mars.jpg');%woman_blonde.tif
%figure,imshow(im) % original
%% imhist and histeq
im_eq = histeq(im, 400); % Transform grayscale
figure,imshowpair(im,im_eq,'montage')
figure,imhist(im),imhist(im_eq)
axis off
%figure,imhist(im)
%figure,imhist(im_eq)
